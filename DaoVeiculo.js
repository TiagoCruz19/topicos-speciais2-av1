  ...
  async obter_veiculo_pelo_codigo(cod_veic) {
    ...
    let promessa = new Promise(function (resolve, reject) {
      ...
      consulta.onsuccess = function (event) {
        if (consulta.result != null) resolve(veiculo.assign(consulta.result));
        else resolve(null);
      };
  ...
  async incluir(veiculo) {
    ...
    let resultado = new Promise((resolve, reject) => {
      ...
      transacao.onerror = (event) => {
        reject(
          new ModelError(
            "Não foi possível incluir o veiculo",
            event.target.error
          )
        );
      };
  ...
  async alterar(veiculo) {
    ...
    let resultado = new Promise(function (resolve, reject) {
      ...
      transacao.onerror = (event) => {
        reject(
          new ModelError(
            "Não foi possível alterar o veiculo",
            event.target.error
          )
        );
      };
  ...
  async excluir(veiculo) {
    ...
    let transacao = await new Promise(function (resolve, reject) {
      ...
      transacao.onerror = (event) => {
        reject(
          new ModelError(
            "Não foi possível excluir o veiculo",
            event.target.error
          )
        );
      };
      ...
      indice.openCursor(keyValue).onsuccess = (event) => {
        ...
        if (cursor) {
          ...
          reject(
            new ModelError("Veiculo com o código " + veiculo.getCod_veic()) +
              " não encontrado!",
            ""
          );
        }
