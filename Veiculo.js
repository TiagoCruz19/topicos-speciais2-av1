...
export default class Veiculo {
  ...
  static validar_cod_veiculo(cod_veic) {
    ...
    if (!padrao_cod_veic.test(cod_veic)) return false;
    return true;
  }
  ...
  static validar_modelo_veic(modelo_veic) {
    if (modelo_veic == null || modelo_veic == "" || modelo_veic == undefined)
      return false;
    if (modelo_veic.length > 40) return false;
    const padrao_modelo_veic = /[A-Z][a-z] */;
    if (!padrao_modelo_veic.test(modelo_veic)) return false;
    return true;
  }
  ...
  static validar_desc_veic(desc_veic) {
    ...
    if (!padrao_desc_veic.test(desc_veic)) return false;
    return true;
  }
  ...
  static validar_valor_veic(valor_veic) {
    ...
    if (!padrao_valor_veic.test(valor_veic)) return false;
    return true;
  }
